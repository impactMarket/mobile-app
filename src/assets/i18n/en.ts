export default {
    ...
    claimed: 'Claimed',
    raised: 'Raised',
    raisedFrom: 'Raised from {{backers}} Backers',
    goal: 'Goal',
    fundsRunOut: 'Community funds will run out in {{days}} days.',
    claim: 'Claim',
    ubi: 'UBI',
    manage: 'Manage',
    ...
    communityRequestErrorDetails:
        'If you have doubts about submitting tickets, <bold>click here</bold>',
