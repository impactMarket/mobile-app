...
i18n.translations = {
    ...
    pt: {
        ...
        close: 'Fechar',
        youCanClaimXin: 'Pode pedir {{symbol}}{{amount}} em',
        claimX: 'Pedir {{symbol}}{{amount}}',
        loading: 'A carregar...',
        youHaveClaimedXoutOfY: 'Recebeu ${{claimed}} de ${{max}}',
        hour: 'hora',
        day: 'dia',
        week: 'semana',
        ...
        oneTimeWelcomeMessage1:
            'impactMarket permite que qualquer comunidade vulnerável crie o seu próprio sistema de renda básica incondicional para os seus beneficiários, onde cada membro tem acesso a um valor fixo numa base regular e fazer pagamentos gratuitamente',
        oneTimeWelcomeMessage2:
