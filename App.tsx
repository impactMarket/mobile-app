...
import AddedScreen from './src/views/community/view/manager/AddedScreen';
import RemovedScreen from './src/views/community/view/manager/RemovedScreen';
import Profile from './src/views/profile';
import CommunityContractABI from './src/contracts/CommunityABI.json';
import AddBeneficiaryScreen from './src/views/community/view/manager/AddBeneficiaryScreen';
